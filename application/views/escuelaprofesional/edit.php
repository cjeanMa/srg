<?php echo form_open('escuelaprofesional/edit/'.$escuelaprofesional['idEscuelaProfesional'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="fechaCreacion" value="<?php echo ($this->input->post('fechaCreacion') ? $this->input->post('fechaCreacion') : $escuelaprofesional['fechaCreacion']); ?>" class="form-control" id="fechaCreacion" />
		</div>
	</div>
	<div class="form-group">
		<label for="res_autorizacion" class="col-md-4 control-label">Res Autorizacion</label>
		<div class="col-md-8">
			<input type="text" name="res_autorizacion" value="<?php echo ($this->input->post('res_autorizacion') ? $this->input->post('res_autorizacion') : $escuelaprofesional['res_autorizacion']); ?>" class="form-control" id="res_autorizacion" />
		</div>
	</div>
	<div class="form-group">
		<label for="fecha_autorizacion" class="col-md-4 control-label">Fecha Autorizacion</label>
		<div class="col-md-8">
			<input type="text" name="fecha_autorizacion" value="<?php echo ($this->input->post('fecha_autorizacion') ? $this->input->post('fecha_autorizacion') : $escuelaprofesional['fecha_autorizacion']); ?>" class="form-control" id="fecha_autorizacion" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="fecha_revalidacion" value="<?php echo ($this->input->post('fecha_revalidacion') ? $this->input->post('fecha_revalidacion') : $escuelaprofesional['fecha_revalidacion']); ?>" class="form-control" id="fecha_revalidacion" />
		</div>
	</div>
	<div class="form-group">
		<label for="disponibilidad" class="col-md-4 control-label">Disponibilidad</label>
		<div class="col-md-8">
			<input type="text" name="disponibilidad" value="<?php echo ($this->input->post('disponibilidad') ? $this->input->post('disponibilidad') : $escuelaprofesional['disponibilidad']); ?>" class="form-control" id="disponibilidad" />
		</div>
	</div>
