    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="optEstudiantes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="estudiante">Lista Estudiantes</a>
            <a class="collapse-item" href="estudiante/add">Nuevo Estudiante</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="optDocentes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones</h6>
            <a class="collapse-item" href="docente">Lista Docentes</a>
            <a class="collapse-item" href="docente/add">Nuevo Docente</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="optMatriculas" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones</h6>
            <a class="collapse-item" href="matricula/regular">Matricula Regular</a>
            <a class="collapse-item" href="matricula/recuperacion">Matricula Recuperacion</a>
            <a class="collapse-item" href="matricula/extraordinaria">Matricula Extraordinaria</a>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="optPracticas" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones</h6>
            <a class="collapse-item" href="practica">Lista Practicas</a>
            <a class="collapse-item" href="practica/add">Nueva Practica</a>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="optPlazos" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones</h6>
            <a class="collapse-item" href="plazomatricula">Plazos Matricula</a>
            <a class="collapse-item" href="plazonota">Plazos Notas</a>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="optProgramas" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones</h6>
            <a class="collapse-item" href="escuelaprofesional">Lista Programas</a>
            <a class="collapse-item" href="escuelaprofesional/add">Nuevo Programa</a>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="optUsuarios" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones</h6>
            <a class="collapse-item" href="usuario">Lista Usuarios</a>
            <a class="collapse-item" href="usuario/add">Nuevo Usuario</a>
        </div>
      </li>
