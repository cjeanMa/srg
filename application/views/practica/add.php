<?php echo form_open('practica/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="institucion" value="<?php echo $this->input->post('institucion'); ?>" class="form-control" id="institucion" />
		</div>
	</div>
	<div class="form-group">
		<label for="encargado" class="col-md-4 control-label">Encargado</label>
		<div class="col-md-8">
			<input type="text" name="encargado" value="<?php echo $this->input->post('encargado'); ?>" class="form-control" id="encargado" />
		</div>
	</div>
	<div class="form-group">
