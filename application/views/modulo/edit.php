<?php echo form_open('modulo/edit/'.$modulo['idModulo'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="idEscuelaProfesional" value="<?php echo ($this->input->post('idEscuelaProfesional') ? $this->input->post('idEscuelaProfesional') : $modulo['idEscuelaProfesional']); ?>" class="form-control" id="idEscuelaProfesional" />
		</div>
	</div>
