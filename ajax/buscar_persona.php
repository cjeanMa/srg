	...
	$dni = $_POST['dni'];
		?>
			...
			<?php
				...
				$query="SELECT x.idPersona, x.nombres, x.apellidoPaterno, x.apellidoMaterno, y.nombre, x.direccion, x.email, x.numcelular, x.sexo, x.fechanacimiento, x.discapacidad, x.conadis, x.fechaingreso
						...
						FROM Persona inner join Estudiante on idPersona = Persona_idPersona WHERE idpersona = '$dni') x 
